...
j_110_js = function(runBeforeShow) { /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {};
     ...
     * EVENTS AND HANDLERS  *
     ************************/
    j_110_beforeshow = function() {
        Tiggzi.CurrentScreen = 'j_110';
        for (var idx = 0; idx < datasources.length; idx++) {
            datasources[idx].__setupDisplay();
        }
    }
    // screen onload
    screen_3671_onLoad = j_110_onLoad = function() {
        screen_3671_elementsExtraJS();
        j_110_windowEvents();
        screen_3671_elementsEvents();
    }
    // screen window events
    screen_3671_windowEvents = j_110_windowEvents = function() {
        $('#j_110').bind('pageshow orientationchange', function() {
            adjustContentHeightWithPadding();
        });
    }
    // screen elements extra js
    screen_3671_elementsExtraJS = j_110_elementsExtraJS = function() {
        // screen (screen-3671) extra code
    }
    // screen elements handler
    screen_3671_elementsEvents = j_110_elementsEvents = function() {
    ...
    $("#j_110").die("pagebeforeshow").live("pagebeforeshow", function(event, ui) {
        j_110_beforeshow();
    });
    if (runBeforeShow) {
        j_110_beforeshow();
...
$("#j_110").die("pageinit").live("pageinit", function(event, ui) {
