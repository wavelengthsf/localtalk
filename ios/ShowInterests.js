...
j_79_js = function(runBeforeShow) { /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {
        'mobilebutton1_8': 'j_86',
        'mobilegrid_2': 'j_83',
        'GridofInterests': 'j_84',
        'mobilelabel1_7': 'j_85'
    };
    ...
    restservice6 = new Tiggr.DataSource(GetInterestsById, {
        'onComplete': function(jqXHR, textStatus) {
            $t.refreshScreenFormElements("j_79");
        },
     ...
     * EVENTS AND HANDLERS  *
     ************************/
    j_79_beforeshow = function() {
        Tiggzi.CurrentScreen = 'j_79';
        for (var idx = 0; idx < datasources.length; idx++) {
            datasources[idx].__setupDisplay();
        }
    }
    // screen onload
    screen_2E1F_onLoad = j_79_onLoad = function() {
    ...
    screen_2E1F_windowEvents = j_79_windowEvents = function() {
        $('#j_79').bind('pageshow orientationchange', function() {
            adjustContentHeightWithPadding();
        });
    }
    // screen elements extra js
    screen_2E1F_elementsExtraJS = j_79_elementsExtraJS = function() {
        // screen (screen-2E1F) extra code
    }
    // screen elements handler
    screen_2E1F_elementsEvents = j_79_elementsEvents = function() {
        $("a :input,a a,a fieldset label").live({
            click: function(event) {
                event.stopPropagation();
            }
        });
        $('#j_82 [name="mobilebutton1_8"]').die().live({
            click: function() {
    ...
    $("#j_79").die("pagebeforeshow").live("pagebeforeshow", function(event, ui) {
        j_79_beforeshow();
    });
    if (runBeforeShow) {
        j_79_beforeshow();
...
$("#j_79").die("pageinit").live("pageinit", function(event, ui) {
