/*
 * JS for Chat2 generated by Tiggzi
 *
...
j_104_js = function(runBeforeShow) { /* Object & array with components "name-to-id" mapping */
    var n2id_buf = {};
     ...
     * EVENTS AND HANDLERS  *
     ************************/
    j_104_beforeshow = function() {
        Tiggzi.CurrentScreen = 'j_104';
        for (var idx = 0; idx < datasources.length; idx++) {
            datasources[idx].__setupDisplay();
        }
    }
    // screen onload
    screen_9F2C_onLoad = j_104_onLoad = function() {
        screen_9F2C_elementsExtraJS();
        j_104_windowEvents();
        screen_9F2C_elementsEvents();
    }
    // screen window events
    screen_9F2C_windowEvents = j_104_windowEvents = function() {
        $('#j_104').bind('pageshow orientationchange', function() {
            adjustContentHeightWithPadding();
        });
    }
    // screen elements extra js
    screen_9F2C_elementsExtraJS = j_104_elementsExtraJS = function() {
        // screen (screen-9F2C) extra code
    }
    // screen elements handler
    screen_9F2C_elementsEvents = j_104_elementsEvents = function() {
    ...
    $("#j_104").die("pagebeforeshow").live("pagebeforeshow", function(event, ui) {
        j_104_beforeshow();
    });
    if (runBeforeShow) {
        j_104_beforeshow();
...
$("#j_104").die("pageinit").live("pageinit", function(event, ui) {
